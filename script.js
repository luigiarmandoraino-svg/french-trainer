const lessons = [
  {
    ...
    exercises: [
      ...
      { en: "Your car is new.", fr: "Ta voiture est nouvelle." },
      { en: "His or her parents are kind.", fr: "Ses parents sont gentils." },
      { en: "My children are here.", fr: "Mes enfants sont ici." },
      { en: "Your brother works today.", fr: "Ton frère travaille aujourd’hui." }
    ],
    pronunciationTip: "In mes amis, tes enfants, and ses enfants, the final s sounds like z because of liaison.",
    commonMistake: "Do not choose mon or ma based on the owner. Choose it based on the noun.",
    learningAdvice: "Learn nouns together with their possessive adjective: mon livre, ma maison, mes amis.",
    nextLesson: "Lesson 11 will focus on aller and the near future: I am going to..."
  },
  {
    number: 11,
    ...
    exercises: [
      ...
      { en: "We are going to eat.", fr: "Nous allons manger." },
      { en: "She is going to call her friend.", fr: "Elle va appeler son amie." },
      { en: "They are going to work tomorrow.", fr: "Ils vont travailler demain." },
      { en: "Are you going to the office?", fr: "Tu vas au bureau ?" }
    ],
    pronunciationTip: "In nous allons, pronounce the liaison: nou-z-allons.",
    commonMistake: "Do not conjugate the second verb after aller. Say Je vais travailler, not Je vais travaille.",
    learningAdvice: "Use aller + infinitive to speak quickly about your plans.",
    nextLesson: "Lesson 12 will focus on prepositions of place: in, on, under, in front of, behind."
  },
  {
    number: 12,
    ...
    exercises: [
      ...
      { en: "The cat is in the house.", fr: "Le chat est dans la maison." },
      { en: "The car is behind the school.", fr: "La voiture est derrière l’école." },
      { en: "The keys are under the book.", fr: "Les clés sont sous le livre." },
      { en: "The child is in front of the door.", fr: "L’enfant est devant la porte." }
    ],
    pronunciationTip: "The final s in sous is silent. It sounds like sou.",
    commonMistake: "Do not confuse sur and sous. Sur means on. Sous means under.",
    learningAdvice: "Practice with objects around you: le téléphone est sur la table, le sac est sous la chaise.",
    nextLesson: "Lesson 13 will focus on faire, meaning to do or to make."
  },
  {
    number: 13,
    ...
    exercises: [
      ...
      { en: "We do sport on Saturday.", fr: "Nous faisons du sport samedi." },
      { en: "They make coffee.", fr: "Ils font du café." },
      { en: "It is hot today.", fr: "Il fait chaud aujourd’hui." },
      { en: "She pays attention.", fr: "Elle fait attention." }
    ],
    pronunciationTip: "Je fais, tu fais, and il fait sound almost the same. The final s and t are silent.",
    commonMistake: "For weather, use faire. Say Il fait chaud, not Il est chaud.",
    learningAdvice: "Learn faire expressions as complete blocks: faire du sport, faire la cuisine, faire les courses.",
    nextLesson: "Lesson 14 will be a short exam covering Lessons 8 to 13."
  },
  {
    number: 14,
  ...
  },
  {
    ...
    exercises: [
      ...
      { en: "We can leave now.", fr: "Nous pouvons partir maintenant." },
      { en: "She cannot come today.", fr: "Elle ne peut pas venir aujourd’hui." },
      { en: "Can you open the door?", fr: "Tu peux ouvrir la porte ?" },
      { en: "They can finish tomorrow.", fr: "Ils peuvent finir demain." }
    ],
    pronunciationTip: "Peux and peut sound the same. The final x and t are silent.",
    commonMistake: "Do not conjugate the second verb after pouvoir. Say Je peux parler, not Je peux parle.",
    learningAdvice: "Use pouvoir when asking for help: Tu peux m’aider ? Vous pouvez répéter ?",
    nextLesson: "Lesson 16 will focus on vouloir, meaning to want and would like."
  },
  {
    number: 16,
    ...
    exercises: [
      ...
      { en: "We want to visit Italy.", fr: "Nous voulons visiter l’Italie." },
      { en: "She does not want coffee.", fr: "Elle ne veut pas de café." },
      { en: "I would like a tea, please.", fr: "Je voudrais un thé, s’il vous plaît." },
      { en: "Do you want to eat now?", fr: "Tu veux manger maintenant ?" }
    ],
    pronunciationTip: "Veux and veut sound the same. The final x and t are silent.",
    commonMistake: "Je veux is correct but direct. In restaurants or shops, je voudrais is more polite.",
    learningAdvice: "Memorize je voudrais as a complete phrase. It is very useful when ordering food or asking for something.",
    nextLesson: "Lesson 17 will focus on devoir, meaning must or to have to."
  }
];

let currentLessonIndex = Number(localStorage.getItem("currentLessonIndex")) || 0;
let currentExerciseIndex = Number(localStorage.getItem("currentExerciseIndex")) || 0;
...
function renderLesson() {
  ...
  document.getElementById("lessonCounter").textContent = `Lesson ${lesson.number}`;
  document.getElementById("lessonTitle").textContent = lesson.title;
  document.getElementById("lessonWhy").textContent = lesson.why;
  document.getElementById("ruleFrench").textContent = lesson.ruleFrench;
  document.getElementById("ruleEnglish").textContent = lesson.ruleEnglish;
  document.getElementById("pronunciationTip").textContent = lesson.pronunciationTip;
...
function renderExercise() {
  const lesson = lessons[currentLessonIndex];
  const exercise = lesson.exercises[currentExerciseIndex % lesson.exercises.length];

  document.getElementById("exerciseEnglish").textContent = exercise.en;
  document.getElementById("answerInput").value = "";
  document.getElementById("feedback").textContent = "";
  document.getElementById("feedback").className = "";
  document.getElementById("correctAnswerBox").innerHTML = "";
}
...
function checkAnswer() {
  ...
  const correctAnswer = exercise.fr;
  ...
  if (normalizedUser === normalizedCorrect) {
    ...
    feedback.textContent = "Almost correct. Check accents, word order, or small missing words.";
  } else {
    feedback.className = "wrong";
    feedback.textContent = "Not yet. Compare your answer with the correct sentence.";
  }
...
function isAlmostCorrect(user, correct) {
  ...
  return matchingWords >= Math.max(1, correctWords.length - 2);
}

function nextExercise() {
  const lesson = lessons[currentLessonIndex];
  currentExerciseIndex = (currentExerciseIndex + 1) % lesson.exercises.length;
